 ...
 * @param text
 */
public record ActLine(String text, boolean end, List<String> tags) {
	...
	public static ActLine INACTIVE = new ActLine(null, true, List.of());

	public static ActLine of(String line, boolean end, List<String> tags) {
		return new ActLine(line, end, tags);
	}
}
