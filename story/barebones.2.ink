...
*   Ever so esteemed[] is he, that you came straight over to him as soon as you could spare the time.
    ...
    b: I'm honored, truly. So how may I serve my distinguished coworker today?
    
    He's pushing it. <>

*   Sure, esteemed[] as far as you can throw Ugg.

    b: Yous breaking my heart here, pal. I thought we was thin as thieves.
    
    You don't think he said it that way on purpose.
-
    So, where's your wallet?
    
    b: What wallet? Yous calling little old me a thief?
...
*   You [can do him one better] could call Lulu over and set up a picnic together, if Barebones wants.
    ...
    b: Hows about we settle this civilized style? Real gentle bones-like.
...
-
    ...
    This will take a lot less time than coaxing him into a snafu. Let's get it over with.
    
    (see todo fetch quest)
...
-
    ...
    b: Would yous believe me if I said I ain't the foggiest how it got there?
...
-
    ...
    b: Wow, would yous look at that. It was in my back pocket the whole time.
    
    b: The kid musta reverse pickpocketed me. That's a trend now, I hear.
...
-
    ...
    b: I don't like when people do that.

    Convinced his bones are suitably rattled, you waltz away the victor.
    
    This can't keep happening. You're going to do something about it.
