...
-
    ...
    She even said it tasted great. You are unsure what that means with respect to Deuterium.
    
    A minor earthquake occurs. You can go ask her yourself in a moment.
    
    l: \[ovo\] Hello < PLAYER_NAME >! By any chance, have you seen Ugg?
...
*   [Let's look for him] You should go look for him. He might have gone off and waddled into trouble.
    ...
    Isn't he the  why the train can't leave town for a week? 
    
    The reports of a mysterious rockslide aren't exactly mysterious for those in the know.
...
*   Let's wait here a bit[]. It's always nice to spend a little alone time with Lulu.
    ...
    * *     Naturally[]. She's such a popular girl, it's a rare delight to have her full attention.
            ...
            l: \[ovo\] Perhaps not my *full* attention. That is a good thing.
...
*   {waiting > 1} [Why does she need to review?] What could a godlike machine wrapped around a fusion reactor have to learn from secondary school nuclear physics?
    ...
    l: \[-v-\] May I ask as to your familiarity with the anatomy of the heart?
    
    That's reasonable, in retrospect. You can't expect a normal girl who snacks on tritium to understand how tritium works.
    
    * *     You learned a thing or two about hearts[] back in nineteen aughtseven.
    
            l: \[o.o\] I beg your pardon?
            
            Nevermind.
    
    * *     You know more about nuclear physics[] than about the heart. Which can be construed in opposite ways, depending on your background. 
...
-
    ...
    u: Ugg... <i>gasp</i> sorry. Chickensaur accident. Many head almost cut off.
    
    l: \[0_0\] Goodness! I am pleased to hear that the chickensaurs are safe.
    
    u: Ugg not mean chickensaur head.
    
    You cannot fathom what transpired offstage. You can safely assume it was not nearly as interesting as you might think. We really don't need to pad for time here.
...
-
    ...
    l: \[>.>\] friendly, sportsmanlike reasons. I just just a little bit curious.
-
    So he can read, and quite well. What is the missing piece of this puzzle?
    ...
    u: Ugg good with tool!
    
    One might say the best, given where we are now.
    
    u: Ugg help find puzzle.
    
    Shall we?
    
    FETCH QUEST HERE: Find glasses for ugg!
    
    ...
    
    u: Is < PLAYER_NAME > sure? Ugg never have glasses before.
    
    u: Glass is just rock. Rock not help Ugg read.
