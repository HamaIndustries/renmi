...
-
    ...
    s: You doubled the amount you had already doubled before I paid.
    
    b: Yous supposed to do it twice, right? Ain't that why they call it double?
    
*   So what is it?
-
    b: 's just a truck loada hot--
    ...
    s: <PLAYER_NAME>, listen. This booth's the only ones licensed to sell these. I say that ain't fair.
    
    s: You think that's fair?
    
*   It's fair[]. They probably worked hard to make so many.

    s: They're imported, bud. These are about as far from something a student can make as moon rocks.
...
*   It's not fair[]. Hot dogs are for everyone. It's in the constitution.
    ...
    b: Wussa constitution?
    
    s: It's a kind of sauce you put on salads. Anyways.
-
...
-
    ...
    s: Forget it. Bratwurst has a better flavor profile.

    b neutral 1: So, whats the deal with the hot dogs anyway?
    
    s neutral 3: You got something against dogs, 'bones? They're a food as fine as any.
    
    b: Hard ta say. Gives me the jeebs. Something about them smells.
...
-
    ...
    s: Everyone's gotta be the bigger fish.
    
    l neutral 0: \[^_^\] Actually, it is because the hot dogs are technically alive.
    ...
    b: L... Lulu... Big girl, sweet lady. Yous pulling my legbone, yeah?
    
    b neutral 2: I ate coupla the cooked ones, see.
    
    s: I don't think anything could survive the nonsense I've seen these folks playing around with today.
    
    l: \[ovo\] I have good news and bad news, Barebones.
    
    l: \[;-;\] The bad news is that the cooked ones are all dead...
    
    b: Thank Moloch and Jebus and Presley that was close.
    
    b: Ones I had was all cooked crispy. Carbon nanostructures. Charcoal, like I like it.
    
    s neutral 3: Lulu. The good news?
    ...
    b neutral 0: I'm gonna be sick.
    
    s neutral 2: Hey Lulu. Get your medical suite ready.
    
    s: I reckon 'bones ain't as dead as he says he is.
