...
=== start ===
    ...
    sh h: See, it's a lot easier to mix with the spatula.
    
    pl a: I don't know what your problem is. I was moving it around just fine.
    
    sh: Sure, but...
    
    sh e: <>It's a little unsanitary to stick your whole arm in the batter, dontcha think?
    
    She has a point. Your uniform would agree.
...
=== ananas
    ...
    sh h: That's exactly right, Ananas! Give it a good strong stir!
    
    a: Just like in Paris. We make it smooth and tight.
    
    You aren't sure what that means, less so with respect to cake batter.
    ...
    - (questions) { stopping:
        ...
        * * "What are we making, anyway? {recipe: Shrimp cake, without shrimp?}"
            ...
            shr a: <> If we survive these guys.
            
            shr: I hoped we could have these done by the time the festival started, but I guess we're making an event of it.
        
            -> questions
            
        * * "The recipe calls for potato?"
        
            - - - (recipe) shr h: Old family recipe: Shrimpcake! 
            <> It's pink like me!
            
            ...
            
            shr e: There's, uh, no shrimp in it. I checked.
        ...
        * * "That's a cute hat." 
            ...
            shr hb: Oh! Yes, it's a bit of an heirloom.
            ...
            * * * "Where did it come from?"
                ...
                shr h: My great-grandfather was the personal chef to ocean royalty.
                
                shr: Princess meru-something. Big ol' clam. Can't remember.
                
                shr: We immigrated onto land before I was born. I'm second gen.
                
                shr s: Aw... Now I miss my folks. I better give 'em a call after the festival ends.
            
                -> hat
                
            * * * "Aren't you supposed to keep your hair under it?"
                
                shr eb: h, yeahhhhh, I guesssss
                
                shr: But I'm not technically the one doing the baking here!
                
                shr h: And have you like, seen the kinds of students making food?
                
                shr s: I know it's a sensitive subject, but I wonder if I should ask Ananas whether its cake needs to come with a pineapple allergy warning...
...
=== kitchen ===
    ...
    * [Someone cool that cucumber!] Wait, are cucumbers a fruit or a vegetable? You ponder a moment, but quickly realize someone will have an annoying hour long conversation on Discord about it. You already promised everyone that you would grant amnesty from your cursed blade for the duration of the festival.

    - sh: So, Plume, as I was saying. Turn it slowly. With your spatula.
